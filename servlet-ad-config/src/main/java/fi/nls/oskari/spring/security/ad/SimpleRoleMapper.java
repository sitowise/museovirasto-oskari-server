...
public abstract class SimpleRoleMapper implements OskariUserMapper {
    ...
    private final static String PREFIX_PROPERTY = "oskari.ad.mapper.role.";
     ...
     */
    public void mapUser(Collection<? extends GrantedAuthority> authority, User user) throws Exception {
        if(roleMap.isEmpty()) {
            // init on first call
            init();
        }
